...
\begin{lstlisting}[language=Coq, caption={Marabou proof tree as an inductive data type in Rocq.}, label={code:proof-tree}, basicstyle=\footnotesize\ttfamily]
...
\begin{lstlisting}[language=Coq, caption={Split inductive type for case splits.}, label={code:formalisation-split}, basicstyle=\footnotesize\ttfamily]
Inductive t : Type :=
  (* variable, value *)
  | single : 'I_n -> R -> t
...
\begin{lstlisting}[language=Coq, caption={Split soundness lemma.}, label={code:soundness-split}, breaklines=true, numbers=left]
